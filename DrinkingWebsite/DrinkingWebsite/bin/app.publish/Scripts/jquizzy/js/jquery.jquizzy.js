...
(function($){	
	...
	var defaults = {
        ...
        endText: 'Take the questionnaire again!',
    ...
    superContainer.find('li').click(function() {
        ...
        console.log(1);
        $(this).parents('.slide-container').find('.next').trigger("click");
    });
    ...
    //    score = roundReloaded(trueCount / questionLength * 100, 2);
		  ...
		  //}
        //' You scored ' + GetSumScore() +
        resultSet = '<h2 class="qTitle">' + '<div class="row"><div><h2 class="blog-post-title"> ' + currentInfo(GetSumScore()) + '</h2>               <span style="margin-bottom: 1.5rem; display: block; width: 20%; height: 5px; background-color: #edab00;"></span>                <div class="blog-post" style="word-wrap: break-word; word-break: normal;">                    <p class="lead">Your score is&nbsp;&nbsp;' + GetSumScore() + judgeSkills(GetSumScore()) + '</h2>' + '<p class="lead">If you want to get more relevant professional resources</p><p> <a class="btn btn-primary btn-lg chen" href="/Resources/Index"" role = "button" > Get Support »</a></p>' + shareButton+ resultSet + '<div class="jquizzy-clear"></div>';
